...
//go:generate go run github.com/keep-network/keep-common/pkg/chain/ethlike/generator -package-name celoutil -host-chain-module github.com/celo-org/celo-blockchain ../../ethlike/generator/template/rate_limiter.go.tmpl rate_limiter.go
